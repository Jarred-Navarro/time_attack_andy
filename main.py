...
class GameView(arcade.View):
    ...
    def reset(self):
        ...
        self.map = arcade.TileMap(MAP_FILE, scaling = WINDOW_WIDTH / 774)
        ...
        self.player = arcade.Sprite(self.resource_path("assets/player_textures/player.png"), scale = 3) # giving player blue slime texture.
